...
export function ColorEntry({ color, selected, onClick }:
    ...
    return (
        <div className={`rounded-full bg-bg-lighter px-[2px] py-[2px] text-center cursor-pointer transition-all
            border-2 border-transparent hover:border-primary ${selected && "!border-primary"} select-none min-w-[30px] min-h-[30px]`}
        onClick={onClick}
        >
